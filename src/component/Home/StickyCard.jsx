...
const StickyCard = (props) => {
  return (
    <div className="h-screen sticky top-0 w-full overflow-hidden">
      <img src={props.img} className="bg-cover w-full h-full object-cover" />
      <div className='absolute top-0 left-0 w-full h-full z-40 flex items-center justify-center'>
        <div className='h-2/5 w-fit gap-3 flex flex-col items-center justify-center'>
          ...
          <div>
            <h2 className='effect relative whitespace-nowrap uppercase font-[League] text-6xl leading-10 md:text-[9rem] lg:text-[9rem] tracking-tighter md:leading-35 lg:leading-35'>{props.ProductName}</h2>
          </div>
        </div>
      </div>
    </div>
